...
try:
	from gui.mods.offhangar import internal_geometry as _internal_geometry
except Exception:
	try:
...
try:
	from gui.mods.offhangar import internal_layout_store as _layout_store
except Exception:
	try:
...
try:
	from gui.mods.offhangar import internal_layout_profiles as _layout_profiles
except Exception:
	try:
...
if _layout_profiles is None:
	try:
		...
		import sys
		import types
		_profile_module_name = 'gui.mods.offhangar.internal_layout_profiles'
		...
		if _layout_profiles is None:
			...
			_layout_profiles.__package__ = 'gui.mods.offhangar'
...
try:
	from gui.mods.offhangar.logging import LOG_EVENT, LOG_EXCEPTION, TRACE_CALL
except Exception:
